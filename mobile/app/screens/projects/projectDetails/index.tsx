...
import SkeletonProjectDetails from "./SkeletonProjectDetails";
...
export default function ProjectDetails() {
  ...
  return (
    <View style={styles.container}>
      ...
      >
        {/* Image Carousel dengan ImageWithSkeleton */}
        ...
        <View style={styles.infoContainer}>
          ...
          {/* Client Info dengan ImageWithSkeleton */}
          {client && (
            <View style={styles.sectionContainer}>
              ...
              <View style={styles.clientCard}>
                <ImageWithSkeleton 
                  source={{ 
                    ...
                    encodeURIComponent(client.fullName) 
                  }} 
      ...
      {!isClientOrOwner && (
        <View style={[styles.footer, { paddingBottom: insets.bottom > 0 ? insets.bottom : 16 }]}>
          ...
          <TouchableOpacity 
            ...
            onPress={() => {
              navigation.navigate("ProjectTerms", { projectId: project._id });
            }}
          >
