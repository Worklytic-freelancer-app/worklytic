...
export default function Chat(): JSX.Element {
  ...
  // Fungsi untuk membuat chat baru (untuk testing)
  const createTestChat = async () => {
    ...
    try {
      // ID pengguna lain untuk testing (ganti dengan ID yang valid)
      const testUserId = "67c30fcda7f0e0fdaccf8b9b"; // Contoh ID
      
      // Buat chat ID
      const chatId = await realtimeChatService.getChatId(user._id, testUserId);
      
      // Kirim pesan test
      await realtimeChatService.sendMessage(chatId, testUserId, "Halo, ini pesan test!");
